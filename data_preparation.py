...
# Import your existing signal processing functions
...
def extract_features_from_stft(stft_result, sr):
    ...
    Uses the output from your existing acoustic_processing function
...
def prepare_data_for_ml(acoustic_file, imu_file, tool_lifetime):
    """
    Prepare data for machine learning using your existing processing functions
    ...
    """
    # Read files using your existing File_reader.py
    ...
    # Process acoustic data using your existing function
    ...
    imu_features = {}
    try:
        # Check if we have the expected columns from your IMU data
